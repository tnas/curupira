...
public class NoFormatNumericToWordsConverterTest {
    ...
    public void shouldTransformNegativXeLong() {
        long negative = -1;
        Assertions.assertThrows(IllegalArgumentException.class, () -> converter.toWords(negative));
    }
    ...
    public void shouldNotTransformAMissingResource() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> converter.toWords(max));
    }
